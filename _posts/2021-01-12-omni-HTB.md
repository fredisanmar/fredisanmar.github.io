...
Tenemos que seguir enumerando par ver si descubrimos alguna forma de sacar en plano la string de las flags.
...
* app: mesh5143
* administrator: _1nt3rn37ofTh1nG

ahora que tenemos credenciales en claro vamos a pasar a obtener sesiones de shel con las claves cargadas.
Para esto vamos a volver al panel de login del principio.
